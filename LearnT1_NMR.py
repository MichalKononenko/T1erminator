...
model = FindT1Model()
prior = UniformDistribution([0, 10])
N_particles=1000000
...
#        guess=np.array([[[0.0001+0.0001*idx_guess]]],dtype=model.expparams_dtype )
...
#        
        expparams=designer.design_expparams_field(guess,0,cost_scale_k=10,disp=False,maxiter=10000,maxfun=10000,store_guess=True,grad_h=1,)
...
#plotting particles and weights 
    ...
    plt.scatter(particles[:,0],weights*10,s = 50*(1+(weights-1/N_particles)*N_particles))
